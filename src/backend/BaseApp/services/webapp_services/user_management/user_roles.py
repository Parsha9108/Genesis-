...
class RolesManageView(APIView):
    ...
    @method_decorator(check_permission(module='rbac', allowed_action='read'))
    ...
    @method_decorator(check_permission(module='rbac', allowed_action='create'))
    ...
    @method_decorator(check_permission(module='rbac', allowed_action='delete'))
