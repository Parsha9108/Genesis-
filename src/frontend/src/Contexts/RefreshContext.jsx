...
// export const RefreshProvider = ({ children, defaultInterval = 5 }) => {
...
//     localStorage.setItem(LOCAL_STORAGE_KEY, newInterval);
//     setRefreshInterval(newInterval);
...
export const RefreshProvider = ({ children, defaultInterval = 5 }) => {
  const getStoredInterval = () => {
    const stored = localStorage.getItem(LOCAL_STORAGE_KEY);
    if (stored === null || stored === 'null') return defaultInterval;
