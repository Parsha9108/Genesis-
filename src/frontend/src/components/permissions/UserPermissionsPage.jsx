// // src/components/admin/UserPermissionsPage.jsx
...
//   Server, FileText, Cog
// } from 'lucide-react';
// import { ArrowLeftIcon as HeroArrowLeft, ShieldCheckIcon } from '@heroicons/react/24/outline';
...
//   // ✅ Get user and return path from navigation state
//   const rawUserData = location.state;
//   console.log('Raw location state:', rawUserData);
  
//   let user = null;
//   let returnTo = '/profile/permissions'; // Default fallback
  
//   if (rawUserData) {
//     // Handle the updated structure with returnTo
//     if (rawUserData.user) {
//       user = rawUserData.user;
//       returnTo = rawUserData.returnTo || '/profile/permissions';
//       console.log('Using nested structure:', { user, returnTo });
//     }
//     // Handle direct user object (backward compatibility)
//     else if (rawUserData.id) {
//       user = rawUserData;
...
//   const [updateUserPermissions, { isLoading: isUpdating, error: updateError }] = useUpdateUserPermissionsMutation();
...
//     // First try to use the explicit returnTo path
//     if (returnTo && returnTo !== '/profile/permissions') {
//       navigate(returnTo);
//     }
...
//   useEffect(() => {
//     console.log('Permission initialization useEffect triggered');
//     console.log('userPermissionData in useEffect:', userPermissionData);
...
//       setHasChanges(false);
//     } else if (userPermissionData && Array.isArray(userPermissionData.permissions) && userPermissionData.permissions.length === 0) {
...
//     const granted = permissions.filter(p => userPermissions.has(p.id)).length;
//     const total = permissions.length;
//     return { granted, total };
//   };

//   const getTotalStats = () => {
//     if (!availablePermissions) return { granted: 0, total: 0 };
...
//     const grantedPermissions = userPermissions.size;
...
//             </p>
//             <div className={`p-4 rounded-lg mb-4 max-w-md mx-auto ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
//               <p className="text-sm font-mono">Debug info:</p>
//               <pre className="text-xs mt-2 overflow-auto">{JSON.stringify(rawUserData, null, 2)}</pre>
//             </div>
//             <button
...
//   if (isLoadingUserPerms || isLoadingAvailable) {
//     return (
//       <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
//           {/* Header */}
...
//                   Managing permissions for {user.username}
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                 User: {isLoadingUserPerms ? 'Loading...' : 'Loaded'} | 
//                 Available: {isLoadingAvailable ? 'Loading...' : 'Loaded'}
//               </p>
//             </div>
//           </div>
//         </div>
...
//   // ✅ Main page content with proper dark theme
//   return (
//     <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
//         {/* ✅ Page Header with proper dark theme colors */}
//         <div className="flex items-center justify-between mb-6">
//           <div className="flex items-center space-x-3">
//             <button
//               onClick={handleBackClick}
...
//                   : 'bg-gray-200 hover:bg-gray-300'
//               }`}
//               title="Go back to user management"
//             >
//               <HeroArrowLeft className="w-5 h-5" />
//             </button>
//             <ShieldCheckIcon 
...
//               >
//                 Managing permissions for <span className="font-medium">{user.username}</span> ({user.role})
//               </p>
//             </div>
//           </div>
...
//               style={{ color: isDarkMode ? "#FFF" : "#111827" }}
//             >
//               {totalStats.granted}/{totalStats.total}
//             </div>
//             <div 
//               className="text-xs"
//               style={{ color: isDarkMode ? "#9CA3AF" : "#6B7280" }}
...
//                 console.log(`Processing category: ${categoryKey}`, permissions);
                
//                 if (!Array.isArray(permissions)) {
//                   console.log(`Skipping non-array category: ${categoryKey}`);
//                   return null;
//                 }
...
//             {/* ✅ Footer with action buttons - proper dark theme */}
//             <div 
...
//                     disabled={isUpdating}
//                     className="px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
//                   >
//                     {isUpdating ? (
//                       <>
