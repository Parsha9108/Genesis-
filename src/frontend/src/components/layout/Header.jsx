...
import { Search, User, LogOut, Palette, Upload, UserCircle, Menu, X } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import PropTypes from 'prop-types';
import { toast } from 'react-toastify';
import NotificationDropdown from './Notification';
import StorageFlag from './Flag';
import '../index.css';
...
const Header = ({
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-[200] px-3 sm:px-4 lg:px-6 py-3 sm:py-4 border-b backdrop-blur-md bg-opacity-70 transition-colors duration-300 ${className}`}
        style={headerStyles}
        {...props}
      >
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Logo */}
            <h1
              className="text-base sm:text-lg lg:text-xl font-bold whitespace-nowrap"
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-4" ref={dropdownRef}>
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 w-48 lg:w-64"
                style={inputStyles}
                aria-label="Search"
              />
            </div>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg transition-colors duration-200 hover:scale-105 active:scale-95"
              style={buttonStyles}
            ...
            {/* ✅ UPDATED: Notifications - Pass alerts instead of notifications */}
            ...
            <div className="relative">
              ...
              >
                <div
                  className="w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold shadow-sm border-2 border-white/20 hover:shadow-md transition-all duration-200"
                  style={{
                ...
                >
                  ...
                  <div className="p-2">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg hover:bg-red-50 dark:hover:bg-red-300/20 transition-colors duration-200 text-red-600 dark:text-red-400 mt-1"
                      role="menuitem"
                    >
